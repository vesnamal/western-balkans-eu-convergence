...
def get_countries(cfg: dict) -> list[str]:
    """All economies to pull: six WB + EU aggregate + comparators + success case + EU-27 backdrop."""
    c = cfg["countries"]
    ...
    eu_members = c.get("eu_members", [])
    return six + eu + comparators + success + eu_members
